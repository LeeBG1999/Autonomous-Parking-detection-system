...
## yolov4
python save_model.py --weights ./data/yolov4_backup.weights --output ./checkpoints/yolov4-416 --input_size 416 --model yolov4 
...
python save_model.py --weights ./data/yolov4_backup.weights --output ./checkpoints/yolov4-416 --input_size 416 --model yolov4 --framework tflite
...
save_model.py:
  --weights: path to weights file
    (default: './data/yolov4_backup.weights')

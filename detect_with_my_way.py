...
f1 = open("detect_car/list_coordinate_car.txt", "r")


# input_folder = 'classify_shadow_images/shadow'
# output_folder = 'detect_car/result_detect_car_shadow'
# f1 = open("detect_car/list_coordinate_car_shadow.txt", "w+")


# input_folder = 'classify_shadow_images/not_shadow'
# output_folder = 'detect_car/result_detect_car_not_shadow'
# f1 = open("detect_car/list_coordinate_car_not_shadow.txt", "w+")
...
def main(_argv):
    ...
    for count, filename in enumerate(list_img_name):
        ...
        utils._draw_with_score(image, pred_bbox, listAxisPoint, listAxisPoint_2,
                           allowed_classes)
